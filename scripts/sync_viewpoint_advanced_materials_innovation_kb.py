...
PURPOSES = {
    "国际科技智库观点演变_官方报告目录_2016-2026.csv": ("战略转向专报", "10399条正式报告目录；2154条已有本地资产，8245条轻量保留", "按具体科技创新问题触发增补"),
    "国际科技智库观点演变_OECD_STI正式系列轻量目录.csv": ("OECD STI轻量目录", "新增2020先进材料协作平台和2025战略情报全文节点", "按平台治理、研发设施、路线图和前瞻机制调用"),
    "国际科技智库观点演变_美国OSTP科学技术创新政策轻量目录.csv": ("OSTP轻量目录", "新增2016国家纳米技术战略全文节点", "按基础研究、跨机构研发、设施和技术转移调用"),
    "国际科技智库观点演变_FAS报告与政策备忘录近十年轻量总目录.csv": ("FAS轻量目录", "新增AI、机器人和自驱动材料实验室正文", "按材料发现、科研数据和公共研发设施调用"),
    "国际科技智库观点演变_欧委会JRC科技创新政策近十年轻量总目录.csv": ("JRC轻量目录", "新增纳米技术转移和增材制造先进材料创新生态节点", "按成果转化、初创企业和区域生态调用"),
    "国际科技智库观点演变_先进材料技术创新平台与中国比较定点增补台账.csv": ("先进材料创新", "6份正式材料、291页或网页、843665个清洗文本字符", "推进材料平台、技术转移、AI材料发现和战略情报编码"),
    "国际科技智库观点演变_先进材料技术创新平台与中国比较定点增补结果.md": ("先进材料创新", "OSTP、JRC、OECD、FAS的2016—2025跨期机制链及选择边界", "按具体材料技术和创新平台问题调用"),
    "国际科技智库观点演变_本地资料库实时进度看板.md": ("实时进度", "10399条目录、2154条本地资产、8245条轻量保留、0条失败与0条真实队列", "每个有界批次完成后刷新"),
...
def main() -> int:
    ...
    row.update({
        "最新文件": "241_先进材料技术创新平台与中国比较定点增补结果.md",
        "沉淀判断": "43个机构家族、1290个科技创新覆盖单元；新增纳米技术战略、先进材料研发平台、技术转移、增材制造生态、AI材料发现与战略情报证据链",
        "覆盖状态": "10399条目录中2154条具有本地资产、8245条轻量保留；中国关联目录748条、本地原文579条、可检索文本574条；显式失败0、真实队列0",
        "推进动作": "推进先进材料技术路线、协作平台、技术转移、AI材料发现和战略情报编码；其他正文按项目问题触发",
    })
