...
NODE_CATALOG_MINIMUM = {"wipo-gii": 1, "nsf-nsb-sei": 1, "eu-srip": 1, "eu-eis": 1, "unesco-science": 1, "unctad-tir": 1, "wipo-wipr": 1, "nesta": 1, "rathenau": 1, "ifp": 1, "eu-stoa": 1, "eu-jrc": 1, "de-efi": 1, "uk-royal-society": 1, "de-acatech": 1, "us-nasem": 1}
...
def fulltext_queue_suppressed(row: dict[str, str]) -> bool:
    ...
    return (
        ...
        or "NASEM跨期精选已完成；其余主题成果保留轻量目录" in status
    )
