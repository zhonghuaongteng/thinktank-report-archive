...
def main() -> None:
    ...
    assert len(list((root / "02_机构轨迹卡").glob("*.md"))) == 14
    ...
    assert len(rows(root / "69_机构节点主题覆盖缺口矩阵.csv")) == 1140
    ...
    assert len(catalog) == expected_catalog_size(
        ...
        light_catalog_count=60 + 443 + 10 + 5 + 45 + 17 + 66 + 2 + 11 + 6 + 5 + 11 + 5 + 5 + 6 + 6 + 15 + 118 + 75 + 155 + 646 + 625 + 176 + 243 + 3743,
    ), len(catalog)
    expected_pdf_paths = {
        Path(value).resolve()
