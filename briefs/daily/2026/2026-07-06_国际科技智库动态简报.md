...
- 纯治理条目：0
- 涉及机构：15
- 高频主题：科技创新, 先进制造, 中国与上海相关, AI治理, 数字经济, 科技人才
...
- [P0] Center for Security and Emerging Technology｜奖金竞赛如何促进AI创新｜https://cset.georgetown.edu/article/how-prize-competitions-enable-ai-innovation/
...
- 摘要：报告围绕前沿 AI 模型第三方评估的安全访问问题，提出威胁分类、访问风险矩阵和治理框架。其核心判断是，外部评估对于模型安全、稳健性和危险能力识别越来越重要，但有效评估往往需要接触模型接口、内部信息、训练数据、评估数据或算力环境，由此带来模型盗取、能力重构、模型操纵、越狱绕过、凭据泄露、持久化访问和武器化等风险。报告建议通过统一术语和访问层级、操作化安全访问实践、建立持续反馈机制，推动开发者、评估者和政策主体之间形成可执行框架。
...
- [P0] RUSI Artificial Intelligence and National Security｜中国与稀土供应链
