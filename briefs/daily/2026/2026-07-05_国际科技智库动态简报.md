...
- 摘要：IISS该篇Strategic Comments围绕DeepSeek发布开放权重前沿AI模型的战略含义展开，重点涉及中国AI能力、开放权重模型扩散、美国出口管制效果、算力约束与模型竞争格局。由于IISS页面可静态抽取的正文有限，本条按`metadata_summary_archive`边界保存元数据、链接和自有摘要，避免对受限内容作全文归档。
