...
- 2026年7月口径更新：后续检索进一步放宽到科技创新发展支撑体系，新增覆盖科技指标、公共研发预算、战略公共投资、科研组织、创新平台、元科研、科研产出与评价、技术转移办公室、大学衍生企业、国际科研合作、产业链价值链、生产能力、供应链韧性、公共算力、数据共享、技能升级、人力资本、高技能人才流动、国防AI和国防创新等报告语言。已完成的历史回填暂不重洗；新增每日抓取和后续批量回填按扩展口径评分与排序。
...
- `config/search_profiles.yaml` 提供可审计检索画像。`broad_innovation_support` 作为后续展开检索、每日监测和批量回填的默认画像，保留科技创新、半导体、先进制造、数字经济、科技人才、国防AI等创新支撑条目，具体覆盖产业链供应链、清洁技术、生物技术、量子与空间技术、创新金融、公共算力、科技指标、研发预算、科研组织、标准和质量基础设施、高技能人才流动等支撑科技创新发展的材料，并排除只命中AI治理或科技治理的纯治理候选；`ai_governance_watch` 仅用于需要集中观察治理议题的专题运行。
