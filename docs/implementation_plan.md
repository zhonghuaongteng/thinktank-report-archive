...
- `config/search_profiles.yaml` 提供可审计检索画像。`broad_innovation_support` 作为后续展开检索、每日监测和批量回填的默认画像，保留科技创新、半导体、先进制造、数字经济、科技人才、国防AI等创新支撑条目，具体覆盖产业链供应链、清洁技术、生物技术、量子与空间技术、创新金融、公共算力、科技指标、研发预算、科研组织、标准/计量/质量基础设施、测试验证、产业公地、研发税收激励、高技能人才流动等支撑科技创新发展的材料，并排除只命中AI治理或科技治理的纯治理候选；`ai_governance_watch` 仅用于需要集中观察治理议题的专题运行。
