...
- 默认抓取批次：第一批，覆盖 RAND、CSET、ITIF、Stanford HAI、Carnegie、Brookings、CNAS、MERICS、OECD.AI、Belfer STPP、IDA STPI、NISTEP、STEPI、CSIS、Bruegel、ECIPE、ASPI、ORF America。
...
- 2026年7月口径更新：后续检索进一步放宽到科技创新发展支撑体系，新增覆盖科技指标、公共研发预算、战略公共投资、科研组织、创新平台、元科研、科研产出与评价、技术转移办公室、大学衍生企业、国际科研合作、产业链价值链、生产能力、供应链韧性、公共算力、数据共享、技能升级、人力资本和高技能人才流动等报告语言。已完成的历史回填暂不重洗；新增每日抓取和后续批量回填按扩展口径评分与排序。
- 同一优先级内，写入队列和每日简报重点区优先保存/展示命中“科技创新、半导体、先进制造、数字经济、科技人才”的候选，再保存/展示纯AI治理候选，以减少小批量写入和简报展开区被治理类材料挤占。
- 日常第一批源池新增 Belfer STPP、IDA STPI、NISTEP、STEPI、CSIS、Bruegel、ECIPE、ASPI、ORF America 等科技政策、STI指标、产业政策、经济安全、供应链和技术竞争来源，增强创新体系、科研投入、科技人才、产业化能力和区域政策比较材料。
