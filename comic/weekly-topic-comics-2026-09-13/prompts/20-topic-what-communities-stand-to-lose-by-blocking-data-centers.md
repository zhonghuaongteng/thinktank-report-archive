...
output: ../pages/20-topic-what-communities-stand-to-lose-by-blocking-data-centers.jpg
aspect_ratio: "16:9"
...
- 标题：阻止数据中心建设，社区会失去什么
- 原文链接：https://itif.org/publications/2026/09/07/what-communities-stand-to-lose-by-blocking-data-centers/
- 优先级：P1
- 主题标签：数字经济
...
- 主要论据：文章用路易斯安那、弗吉尼亚等地的税收案例，以及企业资助再生水、职业培训、电网和清洁能源项目的实例说明收益并非只流向运营商。；其核心判断是，地方争议的政策问题应是如何分摊成本、锁定社区回报，而不是先行设置全面禁令。；需要保留的反方边界是，文中案例主要展示成功安排，水资源、土地、峰值负荷和补贴机会成本在不同地区差异很大，不能据此推定所有项目净收益为正。
- 政策含义（报告确有）：社区可要求开发商承担新增基础设施成本、保护其他电力用户、处理水约束并约定社区投资，以项目级条件治理替代笼统禁止，同时用公开成本收益评估检验企业承诺。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `20-topic-what-communities-stand-to-lose-by-blocking-data-centers.jpg`。
