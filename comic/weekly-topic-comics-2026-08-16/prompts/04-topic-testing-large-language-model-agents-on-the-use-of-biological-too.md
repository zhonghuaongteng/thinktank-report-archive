...
output: ../pages/04-topic-testing-large-language-model-agents-on-the-use-of-biological-too.jpg
aspect_ratio: "16:9"
...
- 机构：RAND
- 标题：Testing Large Language Model Agents on the Use of Biological Tools for Nucleic Acid Synthesis Screening Evasion
- 原文链接：https://www.rand.org/pubs/research_reports/RRA4741-2.html
- 优先级：P0
- 主题标签：科技创新, AI治理

## 需要表达的核心内容

- 核心判断：该材料可从以下要点把握：Large language model agents demonstrate an emerging ability to use biological tools to redesign peptides and proteins for nucleic acid synthesis screening evasion, indicating that agents could lower expertise barriers for hazardous capabilities.
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `04-topic-testing-large-language-model-agents-on-the-use-of-biological-too.jpg`。
