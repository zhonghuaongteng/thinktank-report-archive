...
priority: P1
institution: RAND
source_url: https://www.rand.org/pubs/research_reports/RRA4496-1.html
output: ../pages/12-topic-leveraging-the-federal-select-agent-program-to-oversee-nucleic-a.jpg
aspect_ratio: "16:9"
...
- 机构：RAND
- 标题：扩大联邦选择性病原体计划监管核酸的法律空间
- 原文链接：https://www.rand.org/pubs/research_reports/RRA4496-1.html
- 优先级：P1
- 主题标签：科技创新
...
- 主要论据：报告第一卷聚焦合成遗传材料扩散带来的生物安全风险，审查美国联邦选择性病原体计划（FSAP）能否在现行法律下扩大监管对象。；作者同时反对把活体病原体的全部严格控制机械复制到核酸材料，认为可针对编码危险生物功能的材料采用较低负担的注册和监督方式。；报告的证据主要是对授权法、现行法规和可监管对象边界的法律分析，本卷并未完整评估风险降低效果或对生命科学研究生态的影响。；作者明确把这些收益与负担问题留给第二卷，因而本卷结论属于“具备法律空间”，并不等同于“应立即全面纳管”。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `12-topic-leveraging-the-federal-select-agent-program-to-oversee-nucleic-a.jpg`。
