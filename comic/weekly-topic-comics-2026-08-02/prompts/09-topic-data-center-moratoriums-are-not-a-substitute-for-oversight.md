...
output: ../pages/09-topic-data-center-moratoriums-are-not-a-substitute-for-oversight.jpg
aspect_ratio: "16:9"
...
- 标题：数据中心暂停令不能替代持续监管
- 原文链接：https://www.brookings.edu/articles/data-center-moratoriums-are-not-a-substitute-for-oversight/
- 优先级：P1
- 主题标签：数字经济
...
- 主要论据：Brookings作者支持把暂停期作为调查与协商窗口，但明确反对把暂停令视为完整解决方案，认为长期仍需可执行的问责、透明度和设施影响监管。；文中称至少15个州考虑过暂停建设，至少100个地方政府已经批准相关措施；纽约还对用电达到50兆瓦的数据中心暂停州级环境许可最多一年。；作者以孟菲斯xAI设施引发的空气质量监测和NAACP诉讼为例，说明企业数据不透明会把环境与健康疑虑转化为持续抵制。；报告同时警告，范围过宽的长期禁令会威胁数字经济并造成企业财务损失，而全国算力需求不会因个别地区停建而消失。
- 政策含义（报告确有）：作者建议在暂停期内收集设施影响数据、建立社区利益协议和审计报告要求、举行公开会议，并让企业承担面向社区的信息说明责任。州和联邦层面还应把电费承担从企业自愿承诺升级为可执行的用户保护，确保数据中心成本和环境负担不由周边居民被动承担。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `09-topic-data-center-moratoriums-are-not-a-substitute-for-oversight.jpg`。
