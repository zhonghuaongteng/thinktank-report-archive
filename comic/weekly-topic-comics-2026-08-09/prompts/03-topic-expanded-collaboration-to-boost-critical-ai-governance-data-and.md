...
source_url: https://cset.georgetown.edu/article/expanded-collaboration-to-boost-critical-ai-governance-data-and-tracking-tool/
output: ../pages/03-topic-expanded-collaboration-to-boost-critical-ai-governance-data-and.jpg
aspect_ratio: "16:9"
...
- 标题：CSET联合高校扩展AI治理法规追踪平台
- 原文链接：https://cset.georgetown.edu/article/expanded-collaboration-to-boost-critical-ai-governance-data-and-tracking-tool/
- 优先级：P0
- 主题标签：AI治理, 科技创新
...
- 主要论据：AGORA目前收录1000余项AI相关法律、法规和标准，自2024年上线后已被美国、欧盟等地研究者、实务人员和政策制定者使用。；平台提供通俗摘要、详细元数据、主题标签、筛选器及全文，试图把分散的全球治理文件转化为可检索、可比较的数据集。；CSET继续承担界面和数据基础设施托管，四方团队分别参与文件发现、筛选和标注，以扩大覆盖、缩短处理时间并提升可用性。；机构对合作扩容持明确支持态度，认为跨校研究团队可以维持学生和研究者社区，并推动基于AGORA的分析与工具开发。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `03-topic-expanded-collaboration-to-boost-critical-ai-governance-data-and.jpg`。
