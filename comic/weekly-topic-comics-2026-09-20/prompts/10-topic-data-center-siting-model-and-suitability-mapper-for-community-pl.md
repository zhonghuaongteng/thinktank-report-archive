...
output: ../pages/10-topic-data-center-siting-model-and-suitability-mapper-for-community-pl.jpg
aspect_ratio: "16:9"
...
- 机构：RAND
- 标题：Data Center Siting Model and Suitability Mapper for Community Planners: Overview and Technical Documentation
- 原文链接：https://www.rand.org/pubs/tools/TLA4617-2.html
- 优先级：P1
- 主题标签：AI治理, 数字经济
...
- 主要论据：技术文档说明，模型把电力、用水、土地、网络、劳动力、环境和社区影响等变量组合为可视化比较，而不是给出脱离地方条件的单一答案。；其核心价值在于把数据中心建设从招商口号转化为可审计的多维权衡。；作者强调结果依赖输入数据、权重和情景设定，地方政府仍需结合许可、社区协商和实地核验。；该限制意味着工具可支持筛选和对话，但不能替代正式环境评估或公共决策。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `10-topic-data-center-siting-model-and-suitability-mapper-for-community-pl.jpg`。
