...
priority: P0
institution: RAND
source_url: https://www.rand.org/pubs/external_publications/EP71488.html
output: ../pages/05-topic-artificial-intelligence-and-the-ethics-and-practice-of-evaluatio.jpg
aspect_ratio: "16:9"
...
- 机构：RAND
- 标题：Artificial Intelligence and the Ethics and Practice of Evaluation
- 原文链接：https://www.rand.org/pubs/external_publications/EP71488.html
- 优先级：P0
- 主题标签：AI治理, 科技创新
...
- 主要论据：作者承认AI可用于数据分析、证据综合和决策支持，但警告若把解释权交给模型，评估可能从反思性研究滑向程序化合规。；其关键论据是模型训练和部署中的全球北方偏向，可能使评估标准、数据和问题定义被少数技术提供者塑造。；作者主张在AI推理嵌入机构流程前先建立伦理审查、责任追踪和人类解释权边界。；章节并非否定AI工具，而是要求把效率收益与证据质量、问责和地域代表性同时纳入评估设计。
- 政策含义（报告确有）：政策含义：在评估流程引入AI前设置伦理审查、责任追踪和人类解释权边界，并检查训练数据与标准的地域偏向。
...
- 最终输出为可嵌入周报的单张图片，文件名应为 `05-topic-artificial-intelligence-and-the-ethics-and-practice-of-evaluatio.jpg`。
